...
export class AICustomizeView extends LitElement {
    ...
    async _saveContext(val) {
        this._context = val;
        await jarvis.storage.updatePreference('customPrompt', val);
    }
    ...
    render() {
        const profiles = [
            ...
            { value: 'tse', label: 'TSE Support' },
            { value: 'customer', label: 'Customer P1/O1' },
        ];
                    ...
                    <section class="surface">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select class="control" @change=${this._handleProfileChange}>
                                    ${profiles.map(profile => html`<option value=${profile.value} ?selected=${this.selectedProfile === profile.value}>${profile.label}</option>`)}
                                </select>
                            </div>
