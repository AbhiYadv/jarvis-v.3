...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await jarvis.getVersion();
            const response = await fetch('https://raw.githubusercontent.com/sohzm/jarvis/refs/heads/master/package.json');
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${jarvis.isMacOS ? 'Cmd' : 'Ctrl'}</span
